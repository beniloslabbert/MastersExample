...
### TFs
DNA_OBJECT = '/Users/beniloslabbert/PycharmProjects/MastersCopy/classes/DNA_objs/DNA_length/10k_confined.obj'
CURR_POS= 'box_edge'  # or None
BIND_DIST=3
P_BIND=0.5
TARG_TIME_1D=0.01  # milisec # for 1st round = 1
ONE_D_DIFF_CONSTANT=0.05
THREE_D_DIFF_CONSTANT=3
TIME_SCALE='microsec'
CONTACT_SIZE_BP=0  # controls redundancy
...
STOP_CONDITION = 'bp_target'  # 'bp_target' or 'iter_target'
